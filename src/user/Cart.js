...
const Cart = () => {
  return (
    <div className="mx-auto max-w-7xl px-2 lg:px-0 bg-gray-900 p-5">
      <div className="mx-auto max-w-2xl py-8 lg:max-w-7xl">
        ...
        <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          <section
            ...
            className="rounded-lg bg-gray-800 lg:col-span-8 ml-5 pl-5"
          >
          ...
          <section
            ...
            className="mt-16 mr-5 rounded-md bg-gray-800 lg:col-span-4 lg:mt-0 lg:p-0"
          >
            <h2
              id="summary-heading"
              className=" border-b border-gray-200 px-4 py-3 text-lg font-medium text-gray-300 sm:p-4"
            >
              Price Details
            </h2>
            <div>
              <dl className=" space-y-1 px-2 py-4">
                <div className="flex items-center justify-between">
                  <dt className="text-sm text-gray-400">Price (3 item)</dt>
