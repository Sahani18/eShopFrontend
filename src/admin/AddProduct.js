...
const CreateProduct = () => {
  ...
  const handleChange = (name) => (event) => {
    const values =
      name === "photo" ? event.target.files[0].name : event.target.value;
    ...
    createProduct(user._id, token, formData)
      .then((data) => {
        if (data.error) {
          ...
          return toast(`${createdProduct} created successfully`, {
            type: "success",
            theme: "colored",
          });
        }
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-12">
                ...
                <div className="flex">
                  ...
                  <select className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-700 outline-none focus:border-indigo-500">
